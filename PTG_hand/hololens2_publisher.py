...
if __name__ == "__main__":
    ...
    depth_extrinsics_file = os.path.join(
        os.path.dirname(__file__),
        "data/calibration/Depth_AHaT_extrinsics.yml",
    )

    rig2DepthCamera = HoloLensMessagePublisher.load_depth_extrinsics_from_yaml(
        depth_extrinsics_file
    )
