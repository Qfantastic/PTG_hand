...
def read_info_by_sync(df_sync, num_index):
    ...
    hand_0_matrix = eval(df_sync[num_index_str][21])[7]
    hand_1_matrix = eval(df_sync[num_index_str][21])[8]
    hand_2_matrix = eval(df_sync[num_index_str][21])[9]
    hand_3_matrix = eval(df_sync[num_index_str][21])[10]
...
if __name__ == '__main__':
    ...
    np.save(sequence_folder + 'hand_1_left.npy', all_hand_1)
    np.save(sequence_folder + 'hand_center_left.npy', all_hand_center)
    np.save(sequence_folder + 'world2depth_left.npy', all_world2depth)
    np.save(sequence_folder + 'world2color_leftnpy', all_world2color)
    np.save(sequence_folder + 'index_left.npy', index)
    np.save(sequence_folder + 'camera_info_left.npy', all_camera_info)
    ...
    np.save(sequence_folder + 'old_hand_center_left.npy', center_p_rgb)
    ...
    np.save(sequence_folder + 'new_hand_center_left.npy', new_center_p_rgb)